...
allowance, no cloud/cloud-worker containers, and no schedules. It's the simplest
way to self-host ClusterCode; upgrade to Starter+ for platform AI, scheduling, and
managed compute.
