...
description: Control container network access, filesystem permissions, and resource limits.
---

Every container in ClusterCode launches with a **security profile** that controls network egress, filesystem writability, and process-level hardening. Profiles give you a simple dial between "wide open for prototyping" and "fully locked down for sensitive repos."
