...
ClusterCode is **ticket-driven**. Instead of manually configuring containers, you paste a ticket URL and the system handles everything: fetching context, picking a worker, creating the container, and starting the AI agent with full task context.
