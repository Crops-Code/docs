...
<Aside type="caution" title="CropPilot runs on Anthropic models">
  CropPilot is powered internally by **Anthropic (Claude)** models. Each plan
  ...
  **Anthropic API key** or a **Claude OAuth token** and toggle **Use for
  CropPilot**. The OAuth option routes requests through your personal Claude Code
  subscription.
</Aside>
