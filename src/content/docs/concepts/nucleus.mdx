...
**Nucleus** is ClusterCode's built-in AI assistant. It lives in the orchestrator dashboard and helps you manage workers, launch containers, execute commands, and monitor your cluster — all through natural conversation.
...
- Ask Nucleus to launch a container from a GitHub issue or Azure DevOps ticket
...
- Nucleus will confirm launch details with you before creating a container
