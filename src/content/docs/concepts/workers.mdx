...
A **worker** is a machine that runs containers for ClusterCode. It connects outbound to the orchestrator over WebSocket and executes container operations locally using Podman.
