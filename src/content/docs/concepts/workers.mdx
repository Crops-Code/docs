...
import workersDark from '../../../assets/screenshots/workers-list-dark.png';
import workersLight from '../../../assets/screenshots/workers-list-light.png';
...
The **Workers** page lists every machine connected to your orchestrator, with live CPU, memory, disk, and container counts:

<ThemedImage
  dark={workersDark}
  light={workersLight}
  title="Workers"
  alt="The Workers page showing three connected self-hosted workers, each card listing tenant, CPU, memory, disk, container count, last heartbeat, and status."
/>
