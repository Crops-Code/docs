...
- **Launch dev containers from tickets** — paste a GitHub issue, Azure DevOps work item, Jira ticket, or Linear issue, and CropsCode spins up a container with an AI agent ready to work on it
