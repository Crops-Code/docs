...
By default, Nucleus shows a launch summary and waits for your confirmation before creating a container. Add the `auto-launch` directive to skip the confirmation:
...
Define what Nucleus should do automatically after launching a container. Without a workflow, Nucleus asks if you'd like to open a terminal. With a workflow, it executes your steps instead:
...
Here's a complete NUCLEUS.md that auto-launches containers and starts the AI agent automatically:
