...
description: Connect VS Code to a running ClusterCode container for full IDE access.
---

Open a ClusterCode container in Visual Studio Code to browse files, edit code, and use the integrated terminal as if working locally.

## Prerequisites

- **VS Code** (or VS Code Insiders) installed
- **Dev Containers** extension installed
- A running ClusterCode container
