...
The default ClusterCode container image covers general development. For specialized needs, build your own.
...
<Aside type="tip">
  Prefer to capture a container you've already set up by hand? See [Build an Image from a Container](/guides/build-image-from-container).
</Aside>
...
Or trigger a build from the orchestrator dashboard / Nucleus:
